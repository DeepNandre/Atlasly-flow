...
apply_sql "$MIGRATIONS_DIR/000015_stage0_5_admin_security_exports.up.sql"
...
psql -v ON_ERROR_STOP=1 -h "$SOCK_DIR" -p "$PORT" -d "$DB_NAME" -f "$TESTS_DIR/006_stage0_5_admin_security_exports.sql" >/dev/null

apply_sql "$MIGRATIONS_DIR/000015_stage0_5_admin_security_exports.down.sql"
...
echo "slice6 stage0.5 tests passed"
